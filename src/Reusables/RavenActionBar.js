...
const RavenActionBar = ({
  ...
  if (type === "error") {
    return (
      <div className="action-bar-wrapper-box">
        <div
          className={`action_bar mb-20 ${className} action_bar__error ${
            translateUp && "action_bar__transform"
  ...
  if (type === "warning") {
    return (
      <div className="action-bar-wrapper-box">
        <div
          className={`action_bar mb-20 ${className} action_bar__warning ${
            translateUp && "action_bar__transform"
          } ${visible && "action_bar_show"}`}
        >
          <figure className="img-box">
  ...
  if (type === "info") {
    return (
      <div className="action-bar-wrapper-box">
        <div
          className={`action_bar mb-20 ${className} action_bar__info ${
            translateUp && "action_bar__transform"
          } ${visible && "action_bar_show"}`}
        >
          <figure className="img-box">
