  ...
  return (
    <>
      ...
      >
        ...
        <div style={{ position: 'relative', transform: 'translateX(15rem)' }} className=''>
          {/* tool tip start */}
        ...
        {/* box end */}
        <div style={{ position: 'relative', transform: 'translateX(10rem)' }} className=''>
          {/* tool tip start */}
        ...
        {/* box end */}
        <div style={{ position: 'relative', transform: 'translateX(-100%)' }} className=''>
          {/* tool tip start */}
          <div className='tool-tip-wrap tool-tip_mascot tool-tip-wrap_big tool-tip-wrap__black-light tool-tip-wrap_bottom-center'>
            ...
            <p className='text'>
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Illum, iste beatae. Tempora deserunt fuga
              distinctio odio excepturi eaque vero! Est obcaecati dolore non ad minima, mollitia nulla
            </p>
